...
namespace Web_Services.Services
{
    public class MongoDBService
    {
        ...
        public MongoDBService(IOptions<MongoDBSettings> mongoDBSettings)
        {
            ...
            _bookingColletion =
           database.GetCollection<Booking>(mongoDBSettings.Value.BookingCollection);
            _assistanceColletion =
           database.GetCollection<Assistance>(mongoDBSettings.Value.AssistanceCollection);
        }
